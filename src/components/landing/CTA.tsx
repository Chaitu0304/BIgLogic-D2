  ...
  return (
    <section className="py-24 bg-premium-luxury-gradient-alt bg-grid-premium border-b border-black/5 font-sans-landeros text-[#0A0A0A] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="bg-[#121212] text-white rounded-[32px] p-8 md:p-14 shadow-premium-tactile relative overflow-hidden border border-white/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10 items-stretch">
            ...
            <div className="lg:col-span-7 flex flex-col justify-between text-left">
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-xs font-bold text-white tracking-wide mb-6">
                ...
                <p className="text-lg md:text-xl font-semibold text-[#D9D9D9] mb-8 max-w-xl leading-relaxed">
                ...
                {/* Urgency Live Ticker */}
                <div className="bg-white/2 backdrop-blur-md border border-white/5 p-5 rounded-2xl max-w-lg mb-10 flex items-center justify-between shadow-2xl">
                  <div>
                    <h4 className="text-[10px] font-bold uppercase tracking-wider text-[#A3A3A3] font-tech-landeros">COHORT ENROLLMENT CLOSES IN:</h4>
                    <div className="text-3xl font-bold text-white mt-1 flex items-baseline gap-1 font-tech-landeros">
                      <span>{timeLeft.hours.toString().padStart(2, '0')}</span>
                      <span className="text-sm font-semibold text-[#A3A3A3]">h</span>
                      <span className="text-white/40">:</span>
                      <span>{timeLeft.minutes.toString().padStart(2, '0')}</span>
                      <span className="text-sm font-semibold text-[#A3A3A3]">m</span>
                      <span className="text-white/40">:</span>
                      <span className="text-[#A3A3A3]">{timeLeft.seconds.toString().padStart(2, '0')}</span>
                      <span className="text-sm font-semibold text-[#A3A3A3]">s</span>
                    </div>
                  </div>
              ...
              <div className="bg-white/2 backdrop-blur-md border border-white/5 p-6 md:p-8 rounded-[24px] relative max-w-2xl shadow-xl">
                <div className="absolute -top-3.5 left-6 px-3 py-1 rounded-full bg-white text-[#0A0A0A] text-xs font-bold uppercase tracking-widest font-tech-landeros shadow-sm">
                ...
                <p className="font-semibold text-sm leading-relaxed text-[#D9D9D9] mb-6">
                  If BigLogicAI does not save your estimating team at least 10 hours in your first 30 days of use, we will not only refund your subscription 100% instantly &mdash; <span className="text-emerald-400 font-bold">we will write you a check for $500 for wasting your time.</span> We take 100% of the risk.
                </p>

                {/* Hand-signed signature effect */}
                <div className="flex items-center justify-between border-t border-white/10 pt-4">
                  <span className="flex items-center gap-1.5 text-xs font-bold tracking-wider font-tech-landeros text-[#D9D9D9]">
                    <ShieldCheck className="w-4 h-4 text-emerald-400" />
                    LEGAL BINDING REVERSAL
                  </span>
                  <div className="text-right">
                    <div className="font-serif italic text-xl font-bold text-white tracking-wider select-none font-sans">
                      Chaitanya G.
                    </div>
                    <div className="text-xs font-bold uppercase text-[#A3A3A3] mt-0.5 tracking-wider font-tech-landeros">Founder, BigLogicAI</div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-5 bg-white/5 backdrop-blur-md border border-white/10 rounded-[28px] shadow-2xl p-6 md:p-8 flex flex-col justify-between text-left hover-premium-card z-10 overflow-visible !overflow-visible">
              <div>
                <div className="border-b-2 border-dashed border-white/10 pb-4 mb-6 text-center">
                  <h3 className="font-tech-landeros text-xl font-bold text-white">Value Stack Receipt</h3>
                  <span className="text-xs font-bold uppercase tracking-widest text-[#A3A3A3] font-tech-landeros">INVOICE_PROPOSAL_COHORT_2026</span>
                </div>

                {/* Stack items */}
                <div className="space-y-4 font-semibold text-sm text-[#D9D9D9]">
                ...
                {/* Total calculation */}
                <div className="border-t-2 border-dashed border-white/10 pt-6 mt-8 space-y-3">
                  <div className="flex justify-between items-baseline font-bold text-xs text-[#A3A3A3] tracking-wider font-tech-landeros">
                  ...
                  <div className="text-xs font-bold uppercase text-emerald-400 tracking-wider text-center mt-4 bg-emerald-500/5 border border-emerald-500/10 py-2 rounded-full font-tech-landeros">
                ...
                <div className="text-xs font-mono text-center text-[#A3A3A3] tracking-[0.25em] mt-1.5">
                  * BL-BETA-2026 *
                </div>
              ...
              <div className="mt-8 space-y-4">
                <button
                  ...
                  className="w-full h-14 rounded-full bg-white text-[#0A0A0A] font-bold text-sm tracking-wide flex items-center justify-center gap-2 shadow-lg shadow-white/5 hover:bg-slate-50 transition-all duration-300 active:scale-[0.98]"
                >
                  CLAIM YOUR 3 FREE ESTIMATES <ArrowRight className="w-4 h-4 shrink-0 stroke-[2.5]" />
                </button>
                <div className="text-xs text-center font-bold uppercase tracking-wider text-[#A3A3A3] flex items-center justify-center gap-1.5 font-tech-landeros">
                  <ShieldCheck className="w-4 h-4 text-emerald-400" />

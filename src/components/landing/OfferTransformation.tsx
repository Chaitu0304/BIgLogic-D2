      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="max-w-5xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#F0F0F0] border border-black/10 text-xs font-bold text-[#0A0A0A] tracking-wide mb-6">
            <Zap className="w-3.5 h-3.5 text-neutral-500 fill-black/8" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-6xl mx-auto items-stretch mb-20">
          ...
          <div className="lg:col-span-5 bg-white border border-red-500/10 p-8 md:p-10 shadow-landeros hover:shadow-[0_20px_50px_rgba(239,68,68,0.08)] rounded-3xl flex flex-col justify-between relative overflow-hidden transition-all duration-300 hover:border-red-500/30">
            ...
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-red-950/30 border border-red-500/15 text-red-400 font-bold uppercase tracking-wider text-xs mb-8 font-tech-landeros">
              ...
              <ul className="space-y-6 text-left">
                <li className="flex items-start gap-4">
                  <div className="w-5 h-5 rounded-full bg-red-950/30 border border-red-500/10 flex items-center justify-center shrink-0 mt-0.5 text-red-500">
                    <X className="w-3 h-3 stroke-[3]" />
                  </div>
                  <div>
                    <h4 className="font-tech-landeros text-sm font-bold text-[#0A0A0A]">Slow Manual Data Entry</h4>
                    <p className="text-sm text-[#6B6B6B] font-semibold mt-0.5">Estimators waste 12+ hours per estimate copying material selections, building schedules, and typing spreadsheets.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-5 h-5 rounded-full bg-red-950/30 border border-red-500/10 flex items-center justify-center shrink-0 mt-0.5 text-red-500">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#6B6B6B] font-semibold mt-0.5">Lenders take 30 to 45 days to approve draw requests because of unorganized draw milestones and lack of proof.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-5 h-5 rounded-full bg-red-950/30 border border-red-500/10 flex items-center justify-center shrink-0 mt-0.5 text-red-500">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#6B6B6B] font-semibold mt-0.5">Hiring coordinators and admin workers eating up thousands in margins to handle paperwork and basic coordination.</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="hidden lg:flex lg:col-span-2 items-center justify-center">
            <div className="w-14 h-14 bg-white border border-black/10 rounded-full flex items-center justify-center shadow-md text-[#0A0A0A]">
          ...
          <div className="lg:col-span-5 bg-white border border-green-500/10 p-8 md:p-10 shadow-landeros hover:shadow-[0_20px_50px_rgba(34,197,94,0.1)] rounded-3xl flex flex-col justify-between relative overflow-hidden transition-all duration-300 hover:border-green-500/40">
            ...
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-green-950/30 border border-green-500/15 text-green-400 font-bold uppercase tracking-wider text-xs mb-8 font-tech-landeros">
              ...
              <ul className="space-y-6 text-left">
                <li className="flex items-start gap-4">
                  <div className="w-5 h-5 rounded-full bg-green-950/30 border border-green-500/10 flex items-center justify-center shrink-0 mt-0.5 text-green-500">
                    <Check className="w-3.5 h-3.5 stroke-[3]" />
                  </div>
                  <div>
                    <h4 className="font-tech-landeros text-sm font-bold text-[#0A0A0A]">Instant Estimate Processing</h4>
                    <p className="text-sm text-[#6B6B6B] font-semibold mt-0.5">Simply drop any PDF estimate. Our AI parses and extracts everything into flawless, structured schedules in 45 seconds.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-5 h-5 rounded-full bg-green-950/30 border border-green-500/10 flex items-center justify-center shrink-0 mt-0.5 text-green-500">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#6B6B6B] font-semibold mt-0.5">Format bank-ready milestones automatically, clearing draws and speeding up working capital in days.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-5 h-5 rounded-full bg-green-950/30 border border-green-500/10 flex items-center justify-center shrink-0 mt-0.5 text-green-500">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#6B6B6B] font-semibold mt-0.5">Automate compliance, contracts, estimates, and tasks, letting one manager run the entire reconstruction pipeline.</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="border-t border-green-500/5 pt-6 mt-10">
              <span className="text-[10px] font-bold text-green-500 uppercase tracking-widest font-tech-landeros">
